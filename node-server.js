...
app.use(
    ...
    express.static(__dirname + "/demo") //where your static content is located in your filesystem
);
app.use(
    "/dist", //the URL through which you want to access to you static content
